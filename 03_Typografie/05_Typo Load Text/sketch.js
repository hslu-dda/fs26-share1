...
function setup() {
  ...
  noLoop(); // draw() runs once since we're rendering static text
...
function draw() {
  ...
  // First pass: draw text using p5's built-in text() with bounding box
  // This shows how p5 handles wrapping automatically
  fill(200, 100, 100);
  text(myText, 100, 100, maxWidth);

  // Second pass: manual character-by-character rendering
  // This gives us control over positioning each character individually
  fill(0);
